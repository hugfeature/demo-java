...
public class ProducerDemo {
    public static void main(String[] args){
        ...
        properties.put("bootstrap.servers", "192.168.175.228:9092,192.168.175.228:9093,192.168.175.228:9094");
...
//            producer = new KafkaProducer<>(properties);
            for (int i = 0; i < 10; i++) {
                ...
                producer.send(new ProducerRecord<String, String>("wzx_test1", msg));
                Thread.sleep(500);
